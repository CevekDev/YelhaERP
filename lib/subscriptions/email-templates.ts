...
Profitez de votre essai sans engagement. À la fin de la période d'essai, vous pourrez choisir de vous abonner pour continuer à bénéficier du service.`,
    },
    en: {
      subject: '🎁 Your free trial for {{planName}} has started!',
      body: `Hello {{clientName}},

Great news! Your free trial of the **{{planName}}** plan with {{companyName}} has started.

You have full access to all features until **{{expiresAt}}**. No payment is required during this period.

Enjoy your trial with no commitment. At the end of the trial period, you can choose to subscribe and continue using the service.`,
    },
    ar: {
      subject: '🎁 بدأت فترتك التجريبية المجانية {{planName}} !',
      body: `مرحباً {{clientName}}،

أخبار رائعة! بدأت فترتك التجريبية المجانية لخطة **{{planName}}** لدى {{companyName}} بنجاح.

لديك وصول كامل لجميع الميزات حتى **{{expiresAt}}**. لا يلزم أي دفع خلال هذه الفترة.

استمتع بتجربتك دون أي التزام. في نهاية فترة التجربة، يمكنك الاشتراك لمواصلة الاستفادة من الخدمة.`,
    },
  },
  welcome: {
    fr: {
